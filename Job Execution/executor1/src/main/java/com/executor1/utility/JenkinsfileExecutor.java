...
////        String logFile = "logs/" + jobName + "_" + jobId + "_" + timestamp + ".log";
...
////            futures.add(executorService.submit(() -> runMatrixCombination(jobName, commandsWithLines, finalEnv, logFile, payload)));
////        }
////
...
////    // ============================
////    private boolean runMatrixCombination(String jobName, List<CommandWithLine> commandsWithLines, Map<String, String> env, String logFile, Payload payload) {
...
////                for (Map.Entry<String, String> entry : envMap.entrySet()) cmd = cmd.replace("${" + entry.getKey() + "}", entry.getValue());
////                for (Map.Entry<String, String> entry : env.entrySet()) cmd = cmd.replace("${" + entry.getKey() + "}", entry.getValue());
////
////                String stageName = "Stage-" + stageNum + "_" + comboName;
////                logStageStart(stageName, logFile);
////
////                String errorOutput = runCommand(stageName, cmd, logFile);
////                if (errorOutput != null) {
...
////
////    // ============================
////    // Run command and return error output if failed
////    // ============================
//////    private String runCommand(String stageName, String command, String logFile) throws IOException, InterruptedException {
...
////    private String runCommand(String stageName, String command, String logFile) throws IOException, InterruptedException {
////        logToFile("Running command: " + command, logFile);
////        logToFile("[" + LocalDateTime.now() + "] Running command (Attempt " + attempt +"): " + command, logFile);
////        ProcessBuilder builder = new ProcessBuilder();
////        String os = System.getProperty("os.name").toLowerCase();
////        boolean isWindows = os.contains("win");
////
...
////                if (line.toLowerCase().contains("error") || line.toLowerCase().contains("exception") || line.toLowerCase().contains("traceback")) {
////                    errorOutput.append(line).append("\n");
////                }
////            }
////        }
...
////        int exitCode = process.waitFor();
////        logStageEnd(stageName, exitCode, logFile);
////        return exitCode == 0 ? null : errorOutput.toString().trim(); // return only errors
////    }
////
////    // ============================
...
////           Payload result =  executor.execute(payload);
////
...
//    // ============================
//    private String runCommand(String stageName, String command, String logFile, int attemptNumber) throws IOException, InterruptedException {
