...
//@Service
//@Slf4j
public class JenkinsfileExecutorCopy {
//
...
//    //  Debugging block
//    // ===========================
//    public void Debuggfile(Payload payload){
//        // Debugging block
//        System.out.println("🔍 Trying to access file: " + payload.getPath());
//
...
//
//// If file exists, try to preview first few lines
//        if (f.exists() && f.canRead()) {
//            try (BufferedReader br = new BufferedReader(new FileReader(f))) {
//                System.out.println("📖 Preview of file content:");
...
//                }
//            } catch (Exception e) {
//                System.err.println("⚠️ Error while reading file preview: " + e.getMessage());
//            }
//        }
//
//    }
...
//            log.info(">>> Trying to read Jenkinsfile from path: {}" ,payload.getPath());
//
//            Path path = Paths.get(payload.getPath());
